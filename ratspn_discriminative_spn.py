...
#
# 	trained_spn = SPN.load_pretrained_spn(run_id, dataset_name, spn_args,, perturbations
# 	if trained_spn is None:
# 		dgcspn = SPN.load_spn(dataset_name, spn_args)
# 		trained_spn = SPN.train_generative_spn(run_id, dataset_name, dgcspn, train_x, valid_x, test_x, spn_args,
...
# 	dgcspn = SPN.load_spn(dataset_name, spn_args)
#
# 	trained_spn = SPN.train_generative_spn(1, dataset_name, dgcspn, train_x, valid_x, test_x, spn_args, train_labels=train_labels,
